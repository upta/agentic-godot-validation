...
const ScenarioDriverScript := preload("res://test/scripts/drivers/scenario_driver.gd")
const RuntimeInspectorScript := preload("res://test/scripts/inspector/runtime_inspector.gd")
const ScenarioVerifierScript := preload("res://test/scripts/verifiers/scenario_verifier.gd")

const DEFAULT_SCENARIO_PATH := "res://test/scenarios/move_up_smoke.json"
...
var scenario_path: String = DEFAULT_SCENARIO_PATH
...
func _ready() -> void:
	...
	scenario_path = str(cli.get("scenario_path", DEFAULT_SCENARIO_PATH))
